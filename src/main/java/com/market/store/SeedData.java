...
import com.market.store.repos.OrdersRepository;
...
public class SeedData implements CommandLineRunner
{
    ...
    public void run(String... args) throws Exception
    {
        ...
        Orders o01 = new Orders(1000.00, 600.00, "SOD", c13, a03);
        Orders o02 = new Orders(3000.00, 500.00, "SOD", c19, a10);
        Orders o03 = new Orders(4500.00, 900.00, "SOD", c07, a10);
        Orders o04 = new Orders(2000.00, 400.00, "SOD", c16, a07);
        Orders o05 = new Orders(4000.00, 600.00, "SOD", c22, a02);
        Orders o06 = new Orders(2000.00, 300.00, "SOD", c12, a12);
        Orders o07 = new Orders(3500.00, 2000.00, "SOD", c02, a08);
        Orders o08 = new Orders(2500.00, 400.00, "SOD", c03, a04);
        Orders o09 = new Orders(500.00, 100.00, "SOD", c23, a06);
        Orders o10 = new Orders(4000.00, 700.00, "SOD", c07, a10);
        Orders o11 = new Orders(1500.00, 600.00, "SOD", c08, a04);
        Orders o12 = new Orders(2500.00, 400.00, "SOD", c25, a11);
